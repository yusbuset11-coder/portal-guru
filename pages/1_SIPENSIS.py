...
st.set_page_config(
    page_title="SIPENSIS - Sistem Informasi Presensi Siswa",
    page_icon="📋",
    layout="wide",
)
...
# Header Utama SIPENSIS (Disamakan dengan DIGMA)
st.markdown(
    f"""
    <div class="main-header-card">
        <h2 class="main-title">📋 SIPENSIS: Sistem Informasi Presensi Siswa</h2>
        <p class="sub-desc">Selamat Datang, {guru_nama} di Modul SIPENSIS</p>
        <p class="sub-desc" style="margin-top: 5px;">Kelola dan pantau kehadiran siswa berdasarkan Sekolah, Kelas, dan Mata Pelajaran secara terstruktur.</p>
    </div>
    """,
    unsafe_allow_html=True,
)
