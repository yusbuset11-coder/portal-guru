...
# --- STYLING CSS KHUSUS UI MODERN & PROFESSIONAL (GEMA STYLE) ---
st.markdown(
    """
    <style>
    .stApp {
...
# --- HEADER UTAMA PORTAL PASTI (Tanpa kata "PORTAL", teks lebih besar, ada identitas pengembang) ---
st.markdown(
    """
...
if not st.session_state.logged_in:
  ...
  # --- TAMPILAN BERANDA UTAMA SETELAH LOGIN (Mengganti kotak hijau dengan gaya elegan) ---
  st.markdown(
      f"""
        ...
        <div class="info-notice-card">
            👉 Silakan pilih modul aplikasi di menu sebelah kiri (Sidebar) untuk mulai bekerja <b>(SIPENSIS, DIGMA, SAKTI, GEMA)</b>.
        </div>
        """,
      unsafe_allow_html=True,
  )
    ...
    st.markdown(
        """
            <div class="module-card">
                <h4 style="color: #facc15; margin-top: 0;">Generator Modul Ajar (GEMA)</h4>
  ...
  with col2:
    st.markdown(
        """
            <div class="module-card">
                <h4 style="color: #38bdf8; margin-top: 0;">Modul Lainnya (SIPENSIS, DIGMA, SAKTI)</h4>
